...
abstract class _$AppRouter extends RootStackRouter {
  ...
  final Map<String, PageFactory> pagesMap = {
    ...
    ImageTitleAppBarRoute.name: (routeData) {
      return AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const ImageTitleAppBarPage(),
      );
    },
...
/// generated route for
/// [ImageTitleAppBarPage]
class ImageTitleAppBarRoute extends PageRouteInfo<void> {
  const ImageTitleAppBarRoute({List<PageRouteInfo>? children})
      : super(
          ImageTitleAppBarRoute.name,
          initialChildren: children,
        );

  static const String name = 'ImageTitleAppBarRoute';
